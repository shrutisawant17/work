    ...
    public static void allFunctionalities(Person person, int choice) throws IOException
    {
        ...
        else if (choice == 7)
        {
            ...
            if (bor != null)
            {
                ...
                ArrayList<LateFees> LateFeess = bor.getBorrowedBooks();

                if (!LateFeess.isEmpty())
                {
                    input = takeInput(-1, LateFeess.size());
                    LateFees l = LateFeess.get(input);
        ...
        else if (choice == 8)
        {
            ...
            if (bor != null)
            {
                ...
                if (!LateFeess.isEmpty())
                {
                    ...
                    LateFeess.get(input).renewIssuedBook(new java.util.Date());
                } else
                    System.out
